...
When:
* Lighting varies frame to frame
* You want relative brightness
* You plan to threshold next

Avoid when:
* Absolute brightness matters (rare)
* You already have controlled lighting
